...
// Last updated: 2023-04-27 EDT
// Addons:
// - Anti Revoke Full: Block enterprise cert revokes completely (can last for a long time until filterlist is disabled, cannot install new enterprise apps)
...
function FindProxyForURL(url, host) {
  ...
  var hosts = [
    ...
    "gl-cash.com",
    "global.com",
    "global-support.report",
    "global-support.store",
    "global-surveys.co",
    "globaltraffico.com",
    "glotchat.click",
    "gmonitor.aliimg.com",
    ...
    "yldbt.com",
    "yldmgrimg.net",
    "ynaps.one-mobile-prod.aws.oath.cloud",
    "yoc.mobi",
    "yottacash.com",
    "you-have-won-h1jk.live",
    "youearrid.com",
    "younetmedia.com",
    "your-notice.com",
